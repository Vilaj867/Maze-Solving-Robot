...
BCD_SPARE   RMB 10    ; Extra Space for decimal point
...
START_ST     BRCLR PORTAD0, %00000100, NO_FWD   ; checks if front bumper is released
             JSR INIT_FWD
             MOVB #FWD, CRNT_STATE              ; if so, go to fwd state
             BRA START_EXIT
...
NO_REAR_BUMP LDAA TOF_COUNTER           ; if non of the bumpers are pressed, then
             CMPA T_FWD                 ; if Tc>Tfwd then make FWD turn (FWD turn state)
             BNE NO_FWD_TRN             ; else return to MAIN routine
             JSR INIT_FWD_TRN
...
;*******************************************************************
initLCD     BSET DDRB,%11111111   ; configure Port B for output
...
iloop:      PSHA ; 2 E-clk            |
            ...
            PSHA ;2 E-clk             | 50us  (40 E-clks in one iloop cycle)
            PULA ;3 E-clk             |
            NOP ;1 E-clk              |
            NOP ;1 E-clk              |
...
initAD   MOVB #$C0,ATDCTL2  ;power up AD, select fast flag clear, $C0 = 1100 0000 
         JSR del_50us       ;wait for 50 us
         MOVB #$00,ATDCTL3  ;8 conversions in a sequence
         MOVB #$85,ATDCTL4  ;res=8, conv-clks=2, prescal=12, $85 = 1000 0101
         BSET ATDDIEN,$0C   ;configure pins AN03,AN02 as digital inputs $0C = 0000 1100
         RTS

;*******************************************************************

ENABLE_TOF  LDAA #%10000000
            STAA TSCR1      ; Enable TCNT (counter)
            STAA TFLG2      ; Clear TOF (enables timer overflow flag)
